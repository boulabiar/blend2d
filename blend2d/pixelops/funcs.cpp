...
void bl_pixel_ops_rt_init(BLRuntimeContext* rt) noexcept {
  ...
  // Initialize gradient interpolation ops.
  ...
  // Initialize gradient fill ops.
  funcs.fill_linear_pad_prgb32 = bl::PixelOps::GradientFill::fill_linear_pad_prgb32;
  ...
  if (bl_runtime_has_avx2(rt)) {
    ...
    funcs.fill_linear_pad_prgb32 = bl::PixelOps::GradientFill::fill_linear_pad_prgb32_avx2;
  }
#endif
}
